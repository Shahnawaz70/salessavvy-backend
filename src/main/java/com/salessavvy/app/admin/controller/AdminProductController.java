package com.salessavvy.app.admin.controller;
...
public class AdminProductController {
    ...
    public ResponseEntity<?> addProduct(@RequestBody Map<String, Object> productRequest) {
		try {
            ...
            Product savedProduct =adminProductService.addProductWithImage(name, description, price, stock, categoryId, imageUrl);
